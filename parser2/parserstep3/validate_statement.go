...
// ValidateStatementClausePresence filters valid clauses for the given statement type and context.
// It appends errors to the provided ParseError pointer, but always returns the filtered clauses.
func ValidateStatementClausePresence(stmtType cmn.NodeType, clauses []cmn.ClauseNode, perr *cmn.ParseError) []cmn.ClauseNode {
