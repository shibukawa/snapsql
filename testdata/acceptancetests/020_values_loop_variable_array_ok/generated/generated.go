...
func init() {
	...
	insertusertagsPrograms = make([]cel.Program, 0)
}

// insertUserTags -  Affinity
func insertUserTags(ctx context.Context, executor snapsqlgo.DBExecutor, opts ...snapsqlgo.FuncOpt) (, error) {
	var result 

	// Extract function configuration
	funcConfig := snapsqlgo.GetFunctionConfig(ctx, "insertusertags", "")
