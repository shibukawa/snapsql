...
func init() {
	...
	insertusersPrograms = make([]cel.Program, 0)
}

// insertUsers -  Affinity
func insertUsers(ctx context.Context, executor snapsqlgo.DBExecutor, opts ...snapsqlgo.FuncOpt) (, error) {
	var result 

	// Extract function configuration
	funcConfig := snapsqlgo.GetFunctionConfig(ctx, "insertusers", "")
