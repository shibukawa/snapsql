...
func InsertUser(ctx context.Context, executor snapsqlgo.DBExecutor, user User, createdAt time.Time, updatedAt time.Time, opts ...snapsqlgo.FuncOpt) (interface{}, error) {
