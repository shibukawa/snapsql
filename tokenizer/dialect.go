...
var KeywordSet = map[string]KeywordInfo{
	...
	"DEFAULT": {true, true}, "DELETE": {true, true}, "DESC": {true, true}, "DISTINCT": {true, true}, "DROP": {true, true}, "ELSE": {true, true},
	"END": {true, true}, "EXCEPT": {true, true}, "EXISTS": {true, true}, "FALSE": {true, true}, "FOR": {true, true}, "FOREIGN": {true, true},
	"FROM": {true, true}, "FULL": {true, true}, "GROUP": {true, true}, "HAVING": {true, true}, "IF": {true, true}, "IN": {true, true}, "INDEX": {true, true},
	"INNER": {true, true}, "INSERT": {true, true}, "INTERSECT": {true, true}, "INTO": {true, true}, "IS": {true, true}, "JOIN": {true, true},
	"KEY": {true, true}, "LEFT": {true, true}, "LIKE": {true, true}, "LIMIT": {true, true}, "MATCH": {true, true}, "NATURAL": {true, true},
	"NOT": {true, true}, "NULL": {true, true}, "ON": {true, true}, "OR": {true, true}, "ORDER": {true, true}, "OUTER": {true, true}, "PRIMARY": {true, true},
	"REFERENCES": {true, true}, "RIGHT": {true, true}, "SELECT": {true, true}, "SET": {true, true}, "TABLE": {true, true}, "THEN": {true, true},
	"TO": {true, true}, "TRUE": {true, true}, "UNION": {true, true}, "UNIQUE": {true, true}, "UPDATE": {true, true}, "USING": {true, true},
	"VALUES": {true, true}, "VIEW": {true, true}, "WHEN": {true, true}, "WHERE": {true, true}, "WITH": {true, true},

	// --- PostgreSQL/extended (strict reserved) ---
	"ILIKE": {true, true}, "SIMILAR": {true, true}, "OVER": {true, true}, "PARTITION": {true, true}, "RANGE": {true, true}, "ROWS": {true, true},
	...
	"REGEXP": {true, true}, "RLIKE": {true, true}, "XOR": {true, true}, "REPLACE": {true, true}, "SHOW": {true, true}, "TRIGGER": {true, true},
