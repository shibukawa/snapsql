...
//   - skipLeadingTrivia: bool - 先頭の空白をスキップするか
//
// Returns:
//   - []snapsql.SystemField: 追加されたシステムフィールドのリスト
//   - error: エラー
//
// 生成例:
//
...
func generateInsertIntoClause(into *parser.InsertIntoClause, columns []parser.FieldName, builder *InstructionBuilder, skipLeadingTrivia bool) ([]snapsql.SystemField, error) {
	if into == nil {
		return nil, fmt.Errorf("%w: INSERT INTO clause is required", ErrMissingClause)
	}
