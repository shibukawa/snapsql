...
func CardCreate(ctx context.Context, executor snapsqlgo.DBExecutor, title string, description string, position float64, opts ...snapsqlgo.FuncOpt) (CardCreateResult, error) {
	...
	buildQueryAndArgs := func() (string, []any, error) {
		query := "INSERT INTO cards ( list_id, title, description, position , created_at, updated_at, created_by, updated_by) VALUES ( (SELECT l.id FROM lists AS l JOIN boards b ON l.board_id = b.id  WHERE b.status = 'active' ORDER BY l.stage_order ASC LIMIT 1), $1, $2, $3 , $4, $5, $6, $7)\n\n RETURNING id, list_id, title, description, position, created_at, updated_at"
		args := make([]any, 0)
